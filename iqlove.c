...
board_new(int w, int h){
	...
	// b->config_filename = "iqlove_heart.json";
	// b->width = w;
	// b->height = h;
...
Solve problems from the iqfit puzzle.\n\
  -g file    configuration for the game                             (default: iqlove_heart.json)\n\
...
int
board_process_geometrical(board *b){
	return 0;
}
